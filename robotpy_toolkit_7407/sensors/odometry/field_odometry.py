# This code is adapted from Sidharth Rao's field odometry code during the 2023 FRC Charged Up Season
# Source: https://github.com/Choate-Robotics/7407-DriveCode-ChargedUp/blob/main/sensors/field_odometry.py
...
from robotpy_toolkit_7407.utils.units import seconds
...
class FieldOdometry:
    ...
    def __init__(
            ...
            min_update_wait_time: seconds = 0.05,
            vision_estimator_pose_weight: float = 0.4
    ):
        self.drivetrain: SwerveDrivetrain = drivetrain

        self.last_update_time: seconds | None = None
        self.min_update_wait_time = min_update_wait_time

        self.vision_estimator: VisionEstimator = vision_estimator
        self.vision_estimator_pose_weight = vision_estimator_pose_weight
